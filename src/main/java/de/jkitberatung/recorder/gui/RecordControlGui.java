...
public class RecordControlGui extends AbstractControllerGui 
	...
	public void modifyTestElement(TestElement element) {
		...
		if (element instanceof RecordControl) {
			...
			recorder.setUseIcaFile(citrixPanel.getUseIcaFile());
			recorder.setIcaFilePath(citrixPanel.getIcaFilePath());
		}
	}
	...
	public void configure(TestElement element) {
		...
		citrixPanel.setUseIcaFile(recorder.getUseIcaFile());
		citrixPanel.setIcaFilePath(recorder.getIcaFilePath());
		repaint();
	}
